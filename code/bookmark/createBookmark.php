					...
					<form class="form-horizontal" id="createBookmark" name="createBookmark" method="post" action="createBookmark.php">
						...
						<table>
							...
							<tr>
								...
								<td><textarea name="description" rows="3" disabled><?php echo_formData($description); ?></textarea></td>
							</tr>
							<tr>
								<td><label style="padding-top:5px;">Keywords: </label></td>
								<td><input id="keywords" type="text" name="keyword" value="<?php echo_formData($keyword); ?>" placeholder="Comma Seperated List" disabled></td>
							</tr>
							<tr>
							...
							<tr>
								<td><label>Thumbnail: </label></td>
                                                                <td><input id="imageSrc" type="hidden" name="imageSrc">
                                                                    <img id="timage" style="max-height: 150px; max-width: 200px;" class="img-polaroid" src="/shared/images/placeholder.jpg">
